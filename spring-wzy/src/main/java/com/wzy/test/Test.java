...
import com.wzy.service.Example1;
import com.wzy.service.Example2;
import com.wzy.service.Example3;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		Object object = annotationConfigApplicationContext.getBean("exampleFactoryBean");
		System.out.println(object.getClass());
		Object object1 = annotationConfigApplicationContext.getBean("&exampleFactoryBean");
		System.out.println(object1.getClass());
//		String[] names = annotationConfigApplicationContext.getBeanDefinitionNames();
//		for(String name : names) {
//			System.out.println(name);
//		}
//		UserService userService = (UserService)annotationConfigApplicationContext.getBean("com.wzy.service.Example3");
//		userService.query();
//		System.out.println(annotationConfigApplicationContext.getBean("&com.wzy.service.Example3"));
